...
Print["CLAClassAttributeList = ",Map[ATTName,CLClassAttributeList[i]]];
Print["CLAClassAttributeValueList = ",CLClassAttributeValueList[i]];
Print["CLAClassAttributeDeterminedList = ",CLClassAttributeDeterminedList[i]];
Print["SuperClassChildren = ",Map[CLName,SuperClassChildren[i]]];
Print["Name = ",CLName[i]];
Print["-"];
,{i,1,ClassNb}]]
...
Print["DefaultValue = ",ATTDefaultValue[i]];
...
Print["Class = ",BRClass[i]];
Print["ConcludedAttribute = ",ATTName[BRConcludedAttribute[i]]];
Print["PremisseAttributeList = ",BRPremisseAttributeList[i]];
Print["PremisseInstanceList = ",BRPremisseInstanceList[i]];
Print["-"];
,{i,1,BackwardRuleNb}]]
